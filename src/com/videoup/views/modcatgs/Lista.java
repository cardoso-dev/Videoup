...
public class Lista extends ViewLista{
    ...
    public Lista(Controller ctrl) {
        ...
        initComponents();
        buildTableModel();
        delQry="delete from videoup_catgs WHERE;";
        idn="idcg";
        mainQry="select idcg,catg,dcatg from videoup_catgs vc";
        countQry="select count(*) from videoup_catgs";
        reloadTable(0);
    ...
    protected void applyFilter(){
        ...
        whr="";
        if(nom.length()>0){
            whr=" where "+buildLike4Where(nom,"vc.catg");
        }
        countQry="select count(*) from videoup_catgs vc "+whr;
        reloadTable(0);
    }
