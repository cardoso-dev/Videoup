...
public class Lista extends ViewLista{
    ...
    public Lista(Controller ctrl) {
        ...
        initComponents();
        buildTableModel();
        delQry="delete from videoup_formts WHERE;";
        idn="idcf";
        mainQry="select idcf,frmt,dfrmt from videoup_formts";
        countQry="select count(*) from videoup_formts";
        reloadTable(0);
    ...
    protected void buildTableModel(){
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {},
            new String [] {"Formato", "Descripcion"}
        ){
    ...
    protected void applyFilter(){
        ...
        whr="";
        if(nom.length()>0){
            whr=" where "+buildLike4Where(nom,"frmt");
        }
        countQry="select count(*) From videoup_formts"+whr;
        reloadTable(0);
    }
