...
import com.videoup.views.modgames.Ficha;
import com.videoup.views.modgames.Lista;
 ...
 * @author Pedro
 */
public class CGames extends Controller{
    
    public CGames(Videoup vm,ViewsSelector vsl, String tt, String ico){
        super(vm,vsl,tt,ico,5);
    }
    ...
    public void loadNewFicha(){       
        if(!existsIdFicha(0)){
            addAndShowView(new Ficha(this,0),"Nuevo registro de videojuego");
