...
import com.videoup.views.modcatgs.Ficha;
import com.videoup.views.modcatgs.Lista;
 ...
 * @author Pedro
 */
public class CCatgs extends Controller{
    
    public CCatgs(Videoup vm,ViewsSelector vsl, String tt, String ico){
    ...
    public void loadNewFicha(){
        if(!existsIdFicha(0)){
            addAndShowView(new Ficha(this,0),"Nuevo registro de genero");
